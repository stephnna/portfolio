...
// end of objets creation

// create array that holds the objects

const projects = [project1, project2, project3, project4, project5, project6];

// grab the id of worksection
const sectionElement = document.getElementById('projects-container');
sectionElement.className = 'container-recent';

// creat empty div element that holds eatc work section
...
// Loop through the array for each work section creat the following
